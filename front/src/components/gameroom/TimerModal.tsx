...
export const TimerModal = ({ onSet, onClose }: Props) => {
	...
	return (
		<div className='room-modal-overlay z-[80]' onClick={onClose}>
			<div
				className='relative w-[320px] max-w-full rounded-[18px] p-[22px] flex flex-col gap-[14px]'
				style={{ background: '#0b0d1a', border: '1px solid rgba(68,170,255,0.18)' }}
				onClick={e => e.stopPropagation()}
				onKeyDown={onKeyDown}
			>
				<ModalClose onClose={onClose} />
				<h3 className='text-[15px] font-[700] pr-[40px]' style={{ color: 'rgba(220,230,255,0.9)' }}>{t('room.timer.title')}</h3>
