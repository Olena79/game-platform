...
import { Gamepad2, LogIn, Play, UserRound, Users } from 'lucide-react'
...
export const MobileBottomNav = () => {
	...
	return (
		...
		>
			...
			{/* акаунт (вихід — на сторінці акаунта) / вхід */}
			<NavLink
			...
			>
				{isLoggedIn ? <UserRound size={20} strokeWidth={1.6} /> : <LogIn size={20} strokeWidth={1.6} />}
				<span className='text-[11px] font-[500] uppercase tracking-[0.05em]'>{isLoggedIn ? t('nav.account') : t('auth.tab_login')}</span>
			</NavLink>
