        ...
        >
          ...
          <section className="mb-8">
            ...
            <p style={{ marginTop: "12px" }}>
              <strong>{t("legal.payments_how")}</strong>
            </p>
            <p style={{ marginTop: "8px" }}>{t("legal.payments_how_text")}</p>
            <p style={{ marginTop: "12px" }}>
              <strong>{t("legal.payments_gm_responsibility")}</strong>
            </p>
            <p style={{ marginTop: "8px" }}>
              {t("legal.payments_gm_responsibility_text")}
            </p>
            <p style={{ marginTop: "12px" }}>
              <strong>{t("legal.payments_platform_responsibility")}</strong>
            </p>
            <p style={{ marginTop: "8px" }}>
              {t("legal.payments_platform_responsibility_text")}
            </p>
            <p style={{ marginTop: "12px" }}>
              <strong>{t("legal.payments_disputes")}</strong>
            </p>
            <p style={{ marginTop: "8px" }}>
              {t("legal.payments_disputes_text")}
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p style={{ marginTop: "12px" }}>{t("legal.conduct_intro_tabu")}</p>
            <ul
              style={{
                listStyle: "disc",
                marginLeft: "20px",
          ...
          <section className="mb-8">
            ...
            <p style={{ marginTop: "12px" }}>
              {t("legal.content_rights_grant")}
            </p>
            <p style={{ marginTop: "12px" }}>
              {t("legal.content_rights_removal")}
            </p>
          </section>
