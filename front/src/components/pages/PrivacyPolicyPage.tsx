			...
			<div className='max-w-3xl mx-auto'>
				...
				>
					...
					<section className='mb-8'>
						...
						<ul style={{ listStyle: 'disc', marginLeft: '20px', marginTop: '12px' }}>
							<li><strong>MongoDB Atlas</strong> - {t('legal.service_database')}</li>
							<li><strong>LiveKit</strong> - {t('legal.service_video')}</li>
							<li><strong>Telegram Bot</strong> - {t('legal.service_telegram')}</li>
							<li><strong>Google OAuth</strong> - {t('legal.service_google')}</li>
							<li><strong>Cloudinary</strong> - {t('legal.service_cloudinary')}</li>
							<li><strong>Google Drive</strong> - {t('legal.service_drive')}</li>
							<li><strong>SendGrid</strong> - {t('legal.service_email')}</li>
						</ul>
					</section>
